...
class UrTube:
    """
    Класс ругистрации содержащий атрибуты: список обЪектов user, список объектов video, текущий пользователь.
    """
    ...
    def watch_video(self, video_clip: str):
        if self.current_user and self.current_user.age < 18:
            print('Вам нет 18 лет, пожалуйста покиньте страницу')
        elif self.current_user:
            for video in self.videos:
                if video_clip in video.title:
                    for i in range(1, 11):
                        print(i, end=' ')
                        time.sleep(1)
                    print('Конец видео')
...
class User:
    """
    Класс авторизации пользователя, содержащий атрибуты: логин,пароль,возраст.
    """
